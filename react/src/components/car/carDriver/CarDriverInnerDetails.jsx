...
const CarDriverInnerdetails = (props) => {
    return( <div>
        <div className=" flex flex-col items-start ">
          ...
          <div className="from">From : <span className='text-blue-600'>{props.carPickupLocation}</span></div>
            <div className="to">To : <span className='text-blue-600'>{props.carDropLocation}</span></div>
