    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-8 mx-auto">
        ...
        <div class="flex flex-wrap -m-4">
          ...
          <div class="xl:w-1/4 md:w-1/2 p-4">
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardActions disableSpacing>
                ...
                <IconButton aria-label="share" onClick={notify} >
                  <ShareIcon />
                </IconButton>
                <ExpandMore
                  expand={expanded1}
         ...
         {
          accepted && <div class="xl:w-1/4 md:w-1/2 p-4 ">
                     <Card sx={{ maxWidth: 345 }}>
              <CardHeader
                avatar={
              ...
              <CardActions disableSpacing>
                ...
                <IconButton aria-label="delete" onClick={()=>setaccept(!accepted)} >
                  <ShareIcon />
                </IconButton>
                <ExpandMore
                  expand={expanded}
