                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div class="flex justify-between items-center mb-6">
                      <div class="form-group form-check">
                        ...
                        <label
                          ...
                          for="exampleCheck2"
                        >
                          I hereby confrims that the above information are
                    ...
                    <div class="text-center lg:text-left">
                      ...
                      <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                        ...
                        <Link
                          to="/login"
                          className="text-emerald-600 hover:text-emerald-700 focus:text-emerald-700 transition duration-200 ease-in-out ml-2"
                        >
                          Login
                        </Link>
                      </p>
