        ...
        <div class="container px-3 py-24 mx-auto">
          <div class="mx-auto flex flex-wrap">
            <div class="lg:w-1/2 w-full lg:pl-5 lg:py-2 mt-6 lg:mt-0">
              <img
                alt="ecommerce"
                class=" lg:h-auto h-64 object-cover object-center"
                src={pop6}
              />
            </div>
            <div class="lg:w-1/2 w-full lg:pl-5 lg:py-2 mt-6 lg:mt-0">
              <h1 className="font-sans text-3xl text-gray-800 font-bold ...">
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-600">
                          Yes, ofCourse. we provide a faciity for our valuable
                          customers with this facility. You can make with amex,
                          visa or mastercard
                        </Disclosure.Panel>
                      </>
                    )}
                  ...
                  <Disclosure as="div" className="mt-2">
                    {({ open }) => (
                      <>
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-600">
                          Yes, Once you login to the system, you can see option
                          to create group. you can create a group by putting
                          title, images , adding members etc. also you all can
                  ...
                  <Disclosure as="div" className="mt-2">
                    {({ open }) => (
                      <>
                        <Disclosure.Button className="flex w-full justify-between rounded-lg bg-emerald-100 px-4 py-2 text-left text-sm font-medium text-emerald-900 hover:bg-emerald-200 focus:outline-none focus-visible:ring focus-visible:ring-emerald-500 focus-visible:ring-opacity-75">
                          <span>
                            Can I able write my experience about my trip?
                          </span>
                          <ChevronUpIcon
                            className={`${
                              open ? "rotate-180 transform" : ""
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-600">
                          In footer, you can see option called "write a blog".
                          you are allowed to write blogs with images you have
                          taken. Additionally, you can view others blogs and
                          search too.
                        </Disclosure.Panel>
                      </>
                    )}
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div class="bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                  ...
                  <p class="leading-relaxed mb-5 text-gray-600">
                    We are always welcome to help our valuable customer. Please
                    ask us any help without any hesitation
                  </p>
                  ...
                  <div className="w-3/4">
                    <button class="text-white bg-emerald-500 border-0 py-2 px-6 focus:outline-none hover:bg-emerald-600 rounded text-lg mr-3">
                      Submit
                    </button>
