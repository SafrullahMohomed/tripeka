    ...
    return ( 
        <div className="px-16 mx-auto">
          ...
          <div class="flex justify-center">
            <div class="w-2/5 h-60 p-2 relative bg-cover bg-center">
                <div className="w-full h-full bg-gray-200">
                    <input type="file"
                      onChange={this.fileSelectHandler} accept="image/*" id="banner-upload" hidden/>
                    <label for="banner-upload" class="blog-banner-upload-btn" onClick={this.fileUploadHandler}>
          ...
          <div class="p-2 w-full">
            <textarea type="text" class="w-full h-12 p-2 outline-none border resize-none rounded-sm bg-gray-100 mb-2" placeholder="Blog title" value={this.state.title} onChange={this.changeTitleHandler}></textarea>
            <textarea type="text" class="w-full h-28 p-2 outline-none border resize-none rounded-sm bg-gray-100 mb-2" placeholder="Start writing here..."value={this.state.article} onChange={this.changeArticleHandler}></textarea>
          </div>
