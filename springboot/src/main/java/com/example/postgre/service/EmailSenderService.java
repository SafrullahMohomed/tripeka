...
public class EmailSenderService {
    ...
    private static final String myAccountEmail = "2019cs008@stu.ucsc.cmb.ac.lk";
    private static final String password = "980531740V";
    ...
    public static void sendHtmlMail(String recipient, String body, String subject) throws Exception {
